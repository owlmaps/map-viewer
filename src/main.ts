  ...
  fetchData = async () => {
    ...
    if (this.cache.has(this.currentDateKey)) {
      ...
      if (dayData.unit_count.ru.length === 0) {
        dayData.unit_count.ru = this.latestData && 'unit_count' in this.latestData ? this.latestData.unit_count.ru : [];
      }
      if (dayData.unit_count.ua.length === 0) {
        dayData.unit_count.ua = this.latestData && 'unit_count' in this.latestData ? this.latestData.unit_count.ua : [];
      }
      if (dayData.units.ru.length === 0) {
        dayData.units.ru = this.latestData && 'units' in this.latestData ? this.latestData.units.ru : [];
      }
